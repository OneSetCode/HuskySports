...
ALLOWED_HOSTS = ['127.0.0.1','web-production-dfdf.up.railway.app','https://web-production-dfdf.up.railway.app']
...
# Mongo databse (connect via djongo)
DATABASES = {
     'default': {
         'ENGINE': 'djongo',  
         'NAME': 'mydatabase',
...
CSRF_TRUSTED_ORIGINS = ['https://web-production-dfdf.up.railway.app']
